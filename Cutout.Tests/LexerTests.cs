    ...
    public void Case1()
    {
        ...
        Assert.Collection(
            ...
            token =>
            {
                ...
                Assert.Equal("\r  ", token.ToSpan(text).ToString());
            },
            token =>
            {
                ...
                Assert.Equal(string.Empty, token.ToSpan(text).ToString());
            }
        );
    }
    ...
    public void Case3()
    {
        ...
        Assert.Collection(
            ...
            token =>
            {
                ...
                Assert.Equal("This", token.ToSpan(text).ToString());
            },
            token =>
            {
                Assert.Equal(TokenType.Whitespace, token.Type);
            ...
            token =>
            {
                ...
                Assert.Equal("is", token.ToSpan(text).ToString());
            },
            token =>
            {
                Assert.Equal(TokenType.Whitespace, token.Type);
            ...
            token =>
            {
                ...
                Assert.Equal("some", token.ToSpan(text).ToString());
            },
            token =>
            {
                Assert.Equal(TokenType.Whitespace, token.Type);
            ...
            token =>
            {
                ...
                Assert.Equal(15, token.End.Offset);
                Assert.Equal("raw", token.ToSpan(text).ToString());
            },
            token =>
            {
                Assert.Equal(TokenType.Whitespace, token.Type);
            ...
            token =>
            {
                ...
                Assert.Equal("text", token.ToSpan(text).ToString());
            },
            token =>
            {
                Assert.Equal(TokenType.Eof, token.Type);
    ...
    public void Case4()
    {
        ...
        Assert.Collection(
            ...
            token =>
            {
                ...
                Assert.Equal("and", token.ToSpan(text).ToString());
            },
            token =>
            {
                Assert.Equal(TokenType.Whitespace, token.Type);
            ...
            token =>
            {
                ...
                Assert.Equal("more", token.ToSpan(text).ToString());
            },
            token =>
            {
                Assert.Equal(TokenType.Whitespace, token.Type);
